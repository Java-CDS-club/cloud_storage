...
public class MainController implements Initializable {
    ...
    private final Network network = LoginController.getNetwork();

    @FXML
    TableView<FileInfo> tablePC, tableCloud;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        network.getChannel().writeAndFlush(new Command(TypeCommand.UPDATE_CLOUD_TABLE,""));
        try {
            Thread.sleep(2000);
